...
photo_width_inches = 210/25.4;
photo_height_inches= 262.9/25.4;
...
module photo(){
    if($preview){
        translate([0,-photo_width/2,0])
            cube([4,photo_width,photo_height]);
    } else{
        import("marisandad.stl");
    }
}
